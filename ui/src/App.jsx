...
import logoIcon from './JustLights.Icon.White.svg'
    ...
    <div className="min-h-screen bg-[#0b0d12] text-slate-200">
      <header className="flex h-14 items-center justify-between border-b border-white/10 bg-[#11141b] px-4">
        <div className="flex items-center gap-3">
          ...
          <div><div className="text-base font-black uppercase tracking-[.18em] text-white">JustLights</div><div className="text-[10px] text-slate-500">{settings.projectName}</div></div>
        </div>
